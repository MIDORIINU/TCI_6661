...
\newcommand{\titulolargo}{Inversor CMOS}
\newcommand{\materia}{Tecnología de Circuitos Integrados - 66.61}
\newcommand{\fiuba}{Facultad de Ingeniería - UBA}
\newcommand{\cuatrimestre}{2 \sptext{do} c. 2020} %\sptext{do} $2^{do}$ \textsuperscript{er}
...
\newcommand{\docenteA}{Ing. \textsc{Garcia Inza} Mariano Andrés}
\newcommand{\docenteB}{Ing. \textsc{Carra} Martin Javier}



\newcommand{\thedate}{28 de Octubre de 2020}
...
\definecolor{FIGColor}{RGB}{199,25,0}
\definecolor{TABLEColor}{cmyk}{1,0.00,0.00,0.00}
